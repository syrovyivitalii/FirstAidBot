...
public class CardiopulmonaryResuscitation {
    ...
    private String CPR_Old(){
        ...
        text += "\uD83D\uDD38 Крок 5. Затисніть носові ходи великим і вказівним пальцями та зробіть 2 повних вдування ручним респіратором, плівкою клапанном або 'із рота в рот' тривалістю 1 секунда кожне. Після кожного вдування відпускайте пальці з носових ходів та слідкуйте за підняттям та опусканням грудної клітки, щоб переконатися, що повітря надходить і виходить з легенів. Якщо грудна клітка не піднімається - повторно очистити носові ходи.\n\n";
    ...
    private String CPR_Young(){
        ...
        text += "\uD83D\uDD38 Крок 1. Переконайтеся, що в постраждалого немає свідомості та пульсу. \n\n";
        text += "\uD83D\uDD38 Крок 2. Закиньте голову назад та трохи підніміть підборіддя. Переконайтеся, що в ротовій порожнині немає згустків та дихальні шляхи вільні. \n\n";
        text += "\uD83D\uDD38 Крок 3. Затисніть носові ходи великим і вказівним пальцями та зробіть 5 повних вдуваннь ручним респіратором, плівкою клапанном або 'із рота в рот' тривалістю 1 секунда кожне.\n\n ";
